...
#define ERROR(module, fmt, arg...) log__save(module, kLogLevel_Error, kLogTarget_Stdout | kLogTarget_Filesystem, fmt, ##arg)
#define FATAL(module, fmt, arg...) log__save(module, kLogLevel_Fatal, kLogTarget_Filesystem, fmt, ##arg)
