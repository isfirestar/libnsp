...
#define posix__atomic_inc(ptr)                  __atomic_add_fetch(ptr, 1, __ATOMIC_SEQ_CST)
#define posix__atomic_inc64(ptr)                  __atomic_add_fetch(ptr, 1, __ATOMIC_SEQ_CST)
#define posix__atomic_dec(ptr)                  __atomic_sub_fetch(ptr, 1, __ATOMIC_SEQ_CST)
#define posix__atomic_dec64(ptr)                  __atomic_sub_fetch(ptr, 1, __ATOMIC_SEQ_CST)
