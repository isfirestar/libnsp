...
namespace nsp {
    namespace tcpip {
        ...
        public:
            ...
            NSP_DECLARE_INTERFACE(HTCPLINK, INVALID_HTCPLINK, tcp_create, (tcp_io_callback_t f_usr, const char* l_ipstr, uint16_t l_port), (f_usr, l_ipstr, l_port));
            ...
            NSP_DECLARE_INTERFACE(HUDPLINK, INVALID_HUDPLINK, udp_create, (udp_io_callback_t f_usr, const char* l_ipstr, uint16_t l_port, int flag), (f_usr, l_ipstr, l_port, flag));
            ...
            NSP_DECLARE_INTERFACE(void *, NULL, nis_refctx, (HLNK lnk, int *cbusrctx), (lnk, cbusrctx));
