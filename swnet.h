...
#define NSP_DECLARE_INTERFACE(_Ret, _Routine, _Arg, _Par) \
                        _Ret _Routine _Arg { \
                                ...
                                _Ret r; \
                                void *f = nsp::os::dlsym( shared_library_, #_Routine ); \
                                if (f) { \
...
namespace nsp {
    namespace tcpip {
        ...
        public:
            ...
            NSP_DECLARE_INTERFACE(HTCPLINK, tcp_create, (tcp_io_callback_t f_usr, const char* l_ipstr, uint16_t l_port), (f_usr, l_ipstr, l_port));
            ...
            NSP_DECLARE_INTERFACE(HUDPLINK, udp_create, (udp_io_callback_t f_usr, const char* l_ipstr, uint16_t l_port, int flag), (f_usr, l_ipstr, l_port, flag));
            ...
            NSP_DECLARE_COMM_INTERFACE(nis_setctx, (HLNK lnk, const void * usrctx, int cbusrctx), (lnk, usrctx, cbusrctx));
            NSP_DECLARE_COMM_INTERFACE(nis_getctx, (HLNK lnk, void * usrctx, int* cbusrctx), (lnk, usrctx, cbusrctx));
            NSP_DECLARE_INTERFACE(void *, nis_refctx, (HLNK lnk, int *cbusrctx), (lnk, cbusrctx));
